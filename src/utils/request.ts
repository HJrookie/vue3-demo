...
let downloadLoadingInstance: AxiosInstance;
// 是否显示重新登录
let isReloginShow;

type HeaderTypes = HeadersDefaults & {
  "Content-Type": String;
};
(axios.defaults.headers as HeaderTypes)["Content-Type"] = "application/json;charset=utf-8";
// 创建axios实例

// : AxiosInstance & {
//   headers?: Record<number | string, any>;
// }
...
export const downloadFile = (config: AxiosRequestConfig, customFileName?: string) => {
